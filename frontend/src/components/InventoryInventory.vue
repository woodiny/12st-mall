<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text>
            ...
            <Photo offline label="ProductImg" v-model="value.productImg" :editMode="editMode" @change="change"/>
            <Number label="Stock" v-model="value.stock" :editMode="editMode" :inputUI="''"/>
            <Date label="RegistDt" v-model="value.registDt" :editMode="editMode" :inputUI="''"/>
