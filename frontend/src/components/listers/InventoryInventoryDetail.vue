<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <Photo offline label="ProductImg" v-model="item.productImg" :editMode="false" @change="change" />
            <div>
                <Number label="Stock" v-model="item.stock" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Date label="RegistDt" v-model="item.registDt" :editMode="editMode" @change="change" />
            </div>
            <div>
