...
import stmallhwj.domain.OrderCancelled;
import stmallhwj.domain.Ordered;
...
public class Order {
    ...
    //>>> Clean Arch / Port Method
    //<<< Clean Arch / Port Method
    public static void updateStatus(ReturnCompleted returnCompleted) {
        //implement business logic here:
        ...
        */
        ...
        repository().findById(returnCompleted.get???()).ifPresent(order->{
